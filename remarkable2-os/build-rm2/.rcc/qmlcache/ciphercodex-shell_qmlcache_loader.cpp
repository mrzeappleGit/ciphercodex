...
namespace _qt_qml_CipherCodex_src_Main_qml { 
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_ciphercodex_shell)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_ciphercodex_shell))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_ciphercodex_shell)() {
    return 1;
}
